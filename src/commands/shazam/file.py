...
@app_commands.command(
    name="file",
    description="Try to find a song from the attachment."
)
...
async def cmd_shazam_file(interaction: discord.Interaction, input_media: discord.Attachment, timestamp: Optional[int] = None):
